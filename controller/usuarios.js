...
const usuariosGet = async(req= response, res = response) =>{
    //const {q,nombre ='no envia', apikey} = req.query;
    const {limite=5, desde=0} = req.query; //indicamos que vamos ha recibir un parametro: limite, con valor por defecto 5
...
const usuariosPut = async(req, res = response) =>{
    ...
    //excluyo passwrod, google y correo (no se actualizan) y todo lo demas lo almacena es resto
